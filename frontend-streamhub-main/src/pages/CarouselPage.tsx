...
const imageDetails = [
    { src: pic1, title: "Trolley Troubles, 1931 starring Oswald the Lucky Rabbit", description: "Description for image 1." },
    { src: pic2, title: "Steamboat Willie, 1928 starring Mickey Mouse", description: "Description for image 2." },
    { src: pic3, title: "Cartoon: Cinderella (Laugh-O-Gram), 1922", description: "The Laugh-O-Gram Studio (also called Laugh-O-Gram Studios) was an animation studio located on the second floor of the McConahay Building at 1127 East 31st in Kansas City, Missouri, that operated from June 28, 1921, to October 16, 1923." }
    ];
const CarouselPage = () => {
    return (
                                    ...
                                    <Card className="rounded-lg overflow-hidden border-none">
                                        <CardContent
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    <h3 className="text-3xl font-bold">{imageDetail.title}</h3>

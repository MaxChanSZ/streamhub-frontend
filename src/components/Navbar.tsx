...
const Navbar = () => {
  ...
  return (
    ...
    <div className="h-[10.5vh] sm:h-[10.5vh] md:h-[10.5vh] lg:h-[11vh] xl:h-[11vh] 2xl:h-[11vh] 3xl:h-[12vh] 4xl:h-[12vh] 5xl:h-[12vh] bg-black flex items-center px-4 mt-3 pb-4">
      {/* Logo */}
      <div
          className="flex-shrink-0 ml-2 mr-2 sm:ml-10 sm:mr-6 md:ml-10 md:mr-6 lg:ml-14 lg:mr-10 xl:ml-16 xl:mr-12 2xl:ml-18 2xl:mr-14 3xl:ml-20 3xl:mr-16 4xl:ml-22 4xl:mr-18 5xl:ml-24 5xl:mr-20"
      >
        <Link to={`/`}>
          <img
            src={logo}

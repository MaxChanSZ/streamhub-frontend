...
const WordleLoginButton: React.FC = () => {
  ...
  const words = [
    {
      word: "array",
      hint: "A data structure that stores multiple elements of the same type in a contiguous block of memory",
    },
    {
      word: "props",
      hint: "Short for properties, used to pass data from parent to child components in React",
    },
    {
      word: "state",
      hint: "An object that holds data that may change over time in a component",
    },
    {
      word: "class",
    ...
    {
      word: "loops",
      hint: "Structures that allow you to repeat a block of code multiple times",
    },
    {
      word: "debug",
      hint: "The process of finding and fixing errors in your code",
    },
    {
      word: "scope",
      hint: "Defines the visibility and accessibility of variables in your code",
    },
    {
      word: "event",
      hint: "An action or occurrence detected by a program, often used in user interfaces",
    },
    {
      word: "const",
      hint: "A keyword used to declare variables whose values cannot be changed after initialization",
    },
    {
      word: "fetch",
      hint: "A method used to request and retrieve data from a server or API",
    },
  ];
              ...
              <div className="space-y-4 text-black">
                ...
                {guesses.map((guess, index) => (
                  <div key={index} className="flex space-x-1">
                    {guess
                      .split("")
                      .map((letter, i) => renderLetterBox(letter, i, word))}
                  </div>
                ))}
